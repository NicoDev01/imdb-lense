    ...
    <Card className="bg-gradient-card shadow-card border-border p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-xl font-bold">Filmtitel mit IMDb Rating</h3>
        ...
        <div className="flex gap-2">
          <Button
            ...
            className="hover:bg-secondary text-xs px-2 py-1 h-7"
          >
          ...
          <Button
            ...
            size="sm"
            onClick={onClear}
            className="hover:bg-destructive hover:text-destructive-foreground text-xs px-2 py-1 h-7"
          >
      ...
      {(hasImdbError || hasRatingsError) && (
        <div className="mb-4 p-3 rounded-lg bg-destructive/10 border border-destructive/20">
          <p className="text-sm text-destructive">
            Fehler beim Laden der Daten. Überprüfe deine Internetverbindung.
          </p>
        </div>
      )}
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                {(isLoadingImdb || isLoadingRatings) && (
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  {movieInfo?.imdbId ? (
                    ...
                    <span className="text-sm text-muted-foreground">IMDb-ID nicht gefunden</span>
                  )}
                </div>
                ...
                <div className="flex items-center gap-2">
                  {ratingInfo?.rating ? (
                    ...
                    <span className="text-sm text-muted-foreground">Rating N/A</span>
                  )}
                  ...
                  <Button
                    ...
                    onClick={() => copyToClipboard(
                      `${title}${movieInfo?.imdbId ? ` (${movieInfo.imdbId})` : ''}${ratingInfo?.rating ? ` - Rating: ${ratingInfo.rating}` : ''}`,
